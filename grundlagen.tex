...
%    \only<1>{\includegraphics[width=0.85\textwidth]{img/svg/anschluesse.pdf}}
%    \only<2>{\includegraphics[width=0.85\textwidth]{img/svg/anschluesse_all.pdf}}
%\end{frame}
...
\begin{frame}{keyXchange}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Zentrale Webseite \only<2>{{\color{red}Problem!}}
